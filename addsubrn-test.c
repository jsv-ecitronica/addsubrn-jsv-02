 ...
 * Edit the original source file "addsubrn-test.check" instead.
 */

#include <check.h>

#line 1 "addsubrn-test.check"
#include "addsubrn.h"

START_TEST(validate_rn)
{
#line 4
   //check syntax
...
START_TEST(convertouppercasevalidatechar_rn_test)
{
#line 101
   char num[MAX_LEN] = {""};
...
START_TEST(subtraction_rn_test)
{
#line 202
   int M = MAX_LEN;
   char n1[MAX_LEN] = {""};
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, validate_rn);
    tcase_add_test(tc1_1, convertouppercasevalidatechar_rn_test);
    tcase_add_test(tc1_1, addition_rn_test);
    tcase_add_test(tc1_1, subtraction_rn_test);
